...
<html lang="en">
  <head>
    ...
    <title>Client Register - Techfree</title>
    ...
    <section class="grid md:grid-cols-10 grid-rows-1 max-w-7xl mx-auto">
      ...
      <div class="md:col-span-6 md:h-screen h-fit pb-10 bg-white flex flex-col md:pl-20 md:pr-20 pt-12 pl-8 pr-8 font-sans gap-6">
        <div>
          ...
          <p class="text-lg">Register and find your ideal freelancer!</p>
        </div>
        {{-- @if ($errors->any())
        ...
        @endif --}}
        <form action="{{ route('client.register') }}" method="POST" class="flex flex-col">
          @csrf
